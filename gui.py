...
def update(scrn,board):
    ...
    for i in range (8):
        for j in range (8):
            blockSize = 200
            pygame.draw.rect(scrn,BLUE,pygame.Rect(x, y, blockSize, blockSize),5)
            x += 50
            j = j+1
        i = i+1
        y += 50
...
#load piece images
pieces = {'p': pygame.image.load('black-pawn.png').convert(),
          'n': pygame.image.load('black-knight.png').convert(),
          'b': pygame.image.load('black-bishop.png').convert(),
          'r': pygame.image.load('black-rook.png').convert(),
          'q': pygame.image.load('black-queen.png').convert(),
          'k': pygame.image.load('black-king.png').convert(),
          'P': pygame.image.load('white-pawn.png').convert(),
          'N': pygame.image.load('white-knight.png').convert(),
          'B': pygame.image.load('white-bishop.png').convert(),
          'R': pygame.image.load('white-rook.png').convert(),
          'Q': pygame.image.load('white-queen.png').convert(),
          'K': pygame.image.load('white-king.png').convert(),
